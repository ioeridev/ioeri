...
import classes from './Core.module.css.js';
...
const Core = (props) => {
  ...
  if (core === "body") {
    ...
    return /* @__PURE__ */ React.createElement("body", __spreadValues({ className: rootclass, style: rootstyle }, bodyProps), children);
  }
  if (core === "section") {
    const sectionProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("section", __spreadValues({ className: rootclass, style: rootstyle }, sectionProps), children);
  }
  if (core === "main") {
    const mainProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("main", __spreadValues({ className: rootclass, style: rootstyle }, mainProps), children);
  }
  if (core === "header") {
    const headerProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("header", __spreadValues({ className: rootclass, style: rootstyle }, headerProps), children);
  }
  if (core === "footer") {
    const footerProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("footer", __spreadValues({ className: rootclass, style: rootstyle }, footerProps), children);
  }
  if (core === "article") {
    const articleProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("article", __spreadValues({ className: rootclass, style: rootstyle }, articleProps), children);
  }
  if (core === "embed") {
    const embedProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("embed", __spreadValues({ className: rootclass, style: rootstyle }, embedProps));
  }
  if (core === "a") {
    const _b = rest, { href, target } = _b, aProps = __objRest(_b, ["href", "target"]);
    return /* @__PURE__ */ React.createElement("a", __spreadValues({ href, target, className: rootclass, style: rootstyle }, aProps), children);
  }
  if (core === "button") {
  ...
  if (core === "form") {
    ...
    return /* @__PURE__ */ React.createElement("form", __spreadValues({ className: rootclass, style: rootstyle }, formProps), children);
  }
  if (core === "nav") {
    const navProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("nav", __spreadValues({ className: rootclass, style: rootstyle }, navProps), children);
  }
  if (core === "progress") {
    const progressProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("progress", __spreadValues({ className: rootclass, style: rootstyle }, progressProps), children);
  }
  if (core === "span") {
    const spanProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("span", __spreadValues({ className: rootclass, style: rootstyle }, spanProps), children);
  }
  if (core === "caption") {
    const captionProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("caption", __spreadValues({ className: rootclass, style: rootstyle }, captionProps), children);
  }
  if (core === "center") {
    const centerProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("center", __spreadValues({ className: rootclass, style: rootstyle }, centerProps), children);
  }
  if (core === "col") {
    const colProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("col", __spreadValues({ className: rootclass, style: rootstyle }, colProps));
  }
  if (core === "colgroup") {
    const colgroupProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("colgroup", __spreadValues({ className: rootclass, style: rootstyle }, colgroupProps), children);
  }
  if (core === "bdo") {
    const bdoProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("bdo", __spreadValues({ className: rootclass, style: rootstyle }, bdoProps), children);
  }
  if (core === "small") {
    const smallProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("small", __spreadValues({ className: rootclass, style: rootstyle }, smallProps), children);
  }
  if (core === "details") {
    const _d = rest, { open } = _d, detailsProps = __objRest(_d, ["open"]);
    return /* @__PURE__ */ React.createElement("details", __spreadValues({ open, className: rootclass, style: rootstyle }, detailsProps), children);
  }
  if (core === "summary") {
    const summaryProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("summary", __spreadValues({ className: rootclass, style: rootstyle }, summaryProps), children);
  }
  if (core === "menu") {
    const menuProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("menu", __spreadValues({ className: rootclass, style: rootstyle }, menuProps), children);
  }
  if (core === "menu-item") {
    const menuitemProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("menuitem", __spreadValues({ className: rootclass, style: rootstyle }, menuitemProps));
  }
  if (core === "ol") {
    const olProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("ol", __spreadValues({ className: rootclass, style: rootstyle }, olProps), children);
  }
  if (core === "ul") {
    const ulProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("ul", __spreadValues({ className: rootclass, style: rootstyle }, ulProps), children);
  }
  if (core === "li") {
    const liProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("li", __spreadValues({ className: rootclass, style: rootstyle }, liProps), children);
  }
  if (core === "div") {
    const divProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("div", __spreadValues({ className: rootclass, style: rootstyle }, divProps), children);
  }
  if (core === "strong") {
    const strongProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("strong", __spreadValues({ className: rootclass, style: rootstyle }, strongProps), children);
  }
  if (core === "h1") {
    const _e = rest, h1Props = __objRest(_e, ["role"]);
    return /* @__PURE__ */ React.createElement("h1", __spreadValues({ role: "presentation", className: rootclass, style: rootstyle }, h1Props), children);
  }
  if (core === "h2") {
    const h2Props = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("h2", __spreadValues({ className: rootclass, style: rootstyle }, h2Props), children);
  }
  if (core === "h3") {
    const h3Props = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("h3", __spreadValues({ className: rootclass, style: rootstyle }, h3Props), children);
  }
  if (core === "h4") {
    const h4Props = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("h4", __spreadValues({ className: rootclass, style: rootstyle }, h4Props), children);
  }
  if (core === "h5") {
    const h5Props = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("h5", __spreadValues({ className: rootclass, style: rootstyle }, h5Props), children);
  }
  if (core === "h6") {
    const h6Props = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("h6", __spreadValues({ className: rootclass, style: rootstyle }, h6Props), children);
  }
  if (core === "p") {
    const pProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("p", __spreadValues({ className: rootclass, style: rootstyle }, pProps), children);
  }
  if (core === "kbd") {
    const kbdProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("kbd", __spreadValues({ className: rootclass, style: rootstyle }, kbdProps), children);
  }
  if (core === "blockquote") {
    const blockquoteProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("blockquote", __spreadValues({ className: rootclass, style: rootstyle }, blockquoteProps), children);
  }
  if (core === "q") {
    const qProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("q", __spreadValues({ className: rootclass, style: rootstyle }, qProps), children);
  }
  if (core === "iframe") {
    const _f = rest, { title } = _f, iframeProps = __objRest(_f, ["title"]);
    return /* @__PURE__ */ React.createElement("iframe", __spreadValues({ title, className: rootclass, style: rootstyle }, iframeProps), children);
  }
  if (core === "label") {
    const _g = rest, { htmlFor } = _g, labelProps = __objRest(_g, ["htmlFor"]);
    return /* @__PURE__ */ React.createElement("label", __spreadValues({ className: rootclass, style: rootstyle, htmlFor }, labelProps), children);
  }
  if (core === "input") {
    const inputProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("input", __spreadValues({ className: rootclass, style: rootstyle }, inputProps));
  }
  if (core === "fieldset") {
    const fieldsetProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("fieldset", __spreadValues({ className: rootclass, style: rootstyle }, fieldsetProps), children);
  }
  if (core === "legend") {
    const legendProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("legend", __spreadValues({ className: rootclass, style: rootstyle }, legendProps), children);
  }
  if (core === "textarea") {
    const textareaProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("textarea", __spreadValues({ className: rootclass, style: rootstyle }, textareaProps));
  }
  if (core === "img") {
    const _h = rest, { alt } = _h, imgProps = __objRest(_h, ["alt"]);
    return /* @__PURE__ */ React.createElement("img", __spreadValues({ alt, className: rootclass, style: rootstyle }, imgProps));
  }
  if (core === "svg") {
    const svgProps = __objRest(rest, []);
    return /* @__PURE__ */ React.createElement("svg", __spreadValues({ className: rootclass, style: rootstyle }, svgProps), children);
  }
  if (core === "audio") {
    const _i = rest, { srcLang, label = "" } = _i, audioProps = __objRest(_i, ["srcLang", "label"]);
    return /* @__PURE__ */ React.createElement("audio", __spreadValues({ className: rootclass, style: rootstyle }, audioProps), children, /* @__PURE__ */ React.createElement("track", { kind: "captions", srcLang, label }));
  }
  if (core === "video") {
    const _j = rest, { srcLang, label = "" } = _j, videoProps = __objRest(_j, ["srcLang", "label"]);
    return /* @__PURE__ */ React.createElement("video", __spreadValues({ className: rootclass, style: rootstyle }, videoProps), children, /* @__PURE__ */ React.createElement("track", { kind: "captions", srcLang, label }));
  }
  if (!core) {
    throw new Error(
