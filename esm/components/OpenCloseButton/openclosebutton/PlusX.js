...
const PlusX = (props) => {
  ...
  return /* @__PURE__ */ React.createElement("span", { className: classes.plusX }, /* @__PURE__ */ React.createElement(
    "svg",
    {
  ...
  ), /* @__PURE__ */ React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 48 48", className: classes.plusX2 }, /* @__PURE__ */ React.createElement(
    "path",
    {
