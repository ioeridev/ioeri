...
const Beat = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement("span", { "data-loader-type": "beat", className: rootC, style: rootS }, /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }));
};
