...
const SyncDots = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement("span", { "data-loader-type": "sync-dots", className: rootC, style: rootS }, /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }));
};
