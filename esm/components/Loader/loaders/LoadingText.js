...
const LoadingText = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement("span", { "data-loader-type": "loading-text", className: rootC, style: rootS }, /* @__PURE__ */ React.createElement("span", { className: rootC }, "Loading"), /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }));
};
