...
const CubeBox = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement("span", { "data-loader-type": "orbit-rotate", className: rootC, style: rootS }, /* @__PURE__ */ React.createElement("span", { className: wrapperC }, /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC })));
};
