...
const Pacman = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement("span", { "data-loader-type": "pacman", className: rootC, style: rootS }, /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }), /* @__PURE__ */ React.createElement("span", { className: childC }));
};
