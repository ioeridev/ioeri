...
const Animated = (props) => {
  ...
  if (type === 'transform') {
    const _b = rest,
      { hold = 0.1, opacity, transform, transition, withoutOpacity, children } = _b,
      transformProps = __objRest(_b, [
        'hold',
        'opacity',
        'transform',
        'transition',
    ...
    const getStyletransformVars = (order) => {
      ...
      const setTransformDelay =
        typeof (transform == null ? void 0 : transform.delay) === 'number'
          ? `${transform == null ? void 0 : transform.delay}s`
          : transform == null
          ? void 0
          : transform.delay;
      switch (order) {
        case 'transform':
          ...
          styleVars['--transform-before'] = String(
            (transform == null ? void 0 : transform.before) || 'scale(0)'
          );
          styleVars['--transform-after'] = String(
            (transform == null ? void 0 : transform.after) || 'scale(1)'
          );
          styleVars['--transform-origin'] = String(
            (transform == null ? void 0 : transform.origin) || 'bottom'
          );
    ...
    const transformSt = __spreadValues(
      __spreadValues(__spreadValues({}, getStyleVars('core')), getStyletransformVars('transform')),
      style
    );
    return /* @__PURE__ */ React.createElement(
      'div',
      __spreadValues(
        { ref: transformRef, className: transformCl, style: transformSt },
        transformProps
      ),
      children
    );
  ...
  if (type === 'skew-card-hover') {
    const _c = rest,
      { children, classNames, styles, noShine, getStyleShine, offsetShine = 0, skew = 12 } = _c,
      offsetShineProps = __objRest(_c, [
        'children',
        'classNames',
        'styles',
        'noShine',
    ...
    const offsetShineWValue =
      ((_d = getStyleShine == null ? void 0 : getStyleShine.offset) == null ? void 0 : _d.x) ||
      offsetShine + 50 ||
      ((_e = cardShineRef.current) == null ? void 0 : _e.offsetWidth) ||
      0;
    const offsetShineHValue =
      ((_f = getStyleShine == null ? void 0 : getStyleShine.offset) == null ? void 0 : _f.y) ||
      offsetShine ||
      ((_g = cardShineRef.current) == null ? void 0 : _g.offsetHeight) ||
      0;
    ...
    const SCHShineClass = cnx(
      ['ioeri_Animated_skew-card-hover_shine'],
      classNames == null ? void 0 : classNames.shine
    );
    ...
    const hand_ShinSize =
      typeof (getStyleShine == null ? void 0 : getStyleShine.size) === 'number'
        ? `${getStyleShine == null ? void 0 : getStyleShine.size}px`
        : getStyleShine == null
        ? void 0
        : getStyleShine.size;
          ...
          __spreadValues(
            {
              ...
              style: __spreadValues(
                ...
                styles == null ? void 0 : styles.inner
              ),
            },
            offsetShineProps
          ),
                  ...
                  style: __spreadValues(
                    {
                      ...
                      backgroundColor:
                        (getStyleShine == null ? void 0 : getStyleShine.color) || '#fab005c2',
                      borderRadius: '9999px',
  ...
  if (type === 'pop-over') {
    ...
    const getStylePopOverVars = (order) => {
      ...
      const popoffset =
        (getStylePlacement == null ? void 0 : getStylePlacement.offset) || placementOffset;
      const popoffsetVal = typeof popoffset === 'number' ? `${popoffset}px` : popoffset;
      const sizeArrow =
        (_a2 = getStylePlacement == null ? void 0 : getStylePlacement.arrow) == null
          ? void 0
          : _a2.size;
      ...
      const handleArrowT =
        (_b2 = getStylePlacement == null ? void 0 : getStylePlacement.arrow) == null
          ? void 0
          : _b2.t;
      const handleArrowR =
        (_c2 = getStylePlacement == null ? void 0 : getStylePlacement.arrow) == null
          ? void 0
          : _c2.r;
      const handleArrowB =
        (_d2 = getStylePlacement == null ? void 0 : getStylePlacement.arrow) == null
          ? void 0
          : _d2.b;
      const handleArrowL =
        (_e2 = getStylePlacement == null ? void 0 : getStylePlacement.arrow) == null
          ? void 0
          : _e2.l;
      const handleArrowColor =
        ((_f2 = getStylePlacement == null ? void 0 : getStylePlacement.arrow) == null
          ? void 0
          : _f2.c) || arrowColor;
    ...
    const POstyle = __spreadValues(
      __spreadValues(__spreadValues({}, getStyleVars('core')), style),
      styles == null ? void 0 : styles.trigger
    );
    ...
    additionalProps['data-placement'] = `${
      (getStylePlacement == null ? void 0 : getStylePlacement.placement) || placement
    }`;
    additionalProps['data-variant'] = `${
      (getStylePlacement == null ? void 0 : getStylePlacement.variant) || variant
    }`;
    return /* @__PURE__ */ React.createElement(
      'div',
      __spreadValues(
        { ref, className: PORootClass, style: styles == null ? void 0 : styles.root },
        additionalProps
      ),
      /* @__PURE__ */ React.createElement(
        'div',
      ...
      show &&
        /* @__PURE__ */ React.createElement(
          'div',
          {
            ...
            style: __spreadValues(
              __spreadValues({}, getStylePopOverVars('popover')),
              styles == null ? void 0 : styles.popover
            ),
          },
          popover
        )
  ...
  if (type === 'running-text-1') {
    const _i = rest,
      { placeholders, delayAfterAnimation = 1e3, minDelay = 200, maxDelay = 200 } = _i,
      runningtextone = __objRest(_i, [
        'placeholders',
        'delayAfterAnimation',
        'minDelay',
        'maxDelay',
    ...
    return /* @__PURE__ */ React.createElement(
      'div',
      __spreadValues({ className: RT1rC, style: RT1Rs }, runningtextone),
      /* @__PURE__ */ React.createElement('div', { ref: elementRef })
    );
  }
  if (type === 'running-text-2') {
    const _j = rest,
      { placeholders, speed = 25 } = _j,
      runningtexttwo = __objRest(_j, ['placeholders', 'speed']);
    ...
    return /* @__PURE__ */ React.createElement(
      'div',
      __spreadValues({ className: RT2rC, style: RT2Rs }, runningtexttwo),
      /* @__PURE__ */ React.createElement(
        'div',
        { ref: containerRef, style: { width: '100%', overflow: 'hidden' } },
        /* @__PURE__ */ React.createElement(
          'div',
          { ref: contentRef, style: { display: 'inline-block', whiteSpace: 'nowrap' } },
          placeholders
        )
      )
    );
