...
export type LoaderType = 'pacman' | 'orbit' | 'circle' | 'loading-text' | 'sync-bars' | 'sync-dots' | 'rises' | 'atomic' | 'pulse' | 'classic-buffer' | 'modern-buffer' | 'orbit-rotate' | 'clock-wise' | 'cube-box' | 'beat' | 'line-bar';
