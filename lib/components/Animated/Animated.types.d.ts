...
export type SkewCardHoverProps = {
     ...
     */
    skew?: number;
} & React.AllHTMLAttributes<HTMLElement> & SkewCardHoverStyleProps & SkewCardHoverClassProps;
...
export type PopOverProps = {
    ...
    onClose?: () => void;
} & React.AllHTMLAttributes<HTMLElement> & PopOverStyleProps & PopOverClassProps;
export type RunningTextOneProps = {
    ...
    minDelay?: number;
    maxDelay?: number;
} & Omit<React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>, 'children' | 'placeholder'>;
...
export type AnimatedAllProps = (TransformProps & AnimatedProps & {
    /**
     ...
     */
    type?: 'transform';
}) | (SkewCardHoverProps & AnimatedProps & {
    /**
     *- `type` untuk menentukan animasi apa yang akan digunakan
     *```js
     *type: "transform" | "skew-card-hover" | "pop-and-over" | "running-text-1" | "running-text-2"
     ...
     */
    type?: 'pop-over';
}) | (RunningTextOneProps & AnimatedProps & {
    /**
     *- `type` untuk menentukan animasi apa yang akan digunakan
     *```js
     *type: "transform" | "skew-card-hover" | "pop-and-over" | "running-text-1" | "running-text-2"
     ...
     */
    type?: 'running-text-1';
}) | (RunningTextTwoProps & AnimatedProps & {
    /**
     *- `type` untuk menentukan animasi apa yang akan digunakan
     *```js
     *type: "transform" | "skew-card-hover" | "pop-and-over" | "running-text-1" | "running-text-2"
