...
export interface ColorProps {
    c?: NamedColor | 'currentcolor' | (string & {});
}
...
export type AnchorTargetsProps = {
     ...
     */
    target?: '_about' | '_blank' | '_calendar' | '_contacts' | '_email' | '_external' | '_file' | '_ftp' | '_media' | '_messaging' | '_noopener' | '_noreferrer' | '_parent' | '_search' | '_self' | '_sms' | '_tel' | '_top' | (string & {});
};
/**
 *### ViewPortProps
 * properti:
