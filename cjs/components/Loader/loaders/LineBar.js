...
const LineBar = (_a) => {
  ...
  const rootC = cnx.cnx([Loader_module["default"].root, Loader_module["default"].lineBarRoot], className);
  const childC = Loader_module["default"].lineBar;
  return /* @__PURE__ */ React__default.createElement("span", { "data-loader-type": "line-bar", className: rootC, style: rootS }, /* @__PURE__ */ React__default.createElement("span", { className: childC }));
};
LineBar.classes = Loader_module["default"];
