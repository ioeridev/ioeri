...
const Orbit = (_a) => {
  ...
  const rootC = cnx.cnx([Loader_module["default"].root, Loader_module["default"].orbit], className);
  return /* @__PURE__ */ React__default.createElement("span", { "data-loader-type": "orbit", className: rootC, style: rootS });
};
Orbit.classes = Loader_module["default"];
