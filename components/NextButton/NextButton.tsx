...
export type NextButtonAllProps =
  | (hand_AnchorProps &
      NextButtonProps & {
        /** diharuskan memilih salah satu **`component`** sebagai komponen induk.
         *- component **`anchor`** sebagai komponen induk.
  ...
  | (hand_ButtonProps &
      NextButtonProps & {
        /** diharuskan memilih salah satu **`component`** sebagai komponen induk.
         *- component **`button`** sebagai komponen induk.
  ...
  | (DivProps &
      NextButtonProps & {
        /** diharuskan memilih salah satu **`component`** sebagai komponen induk.
         *- component **`div`** sebagai komponen induk.
 ...
 * You have choose 1 of 3 components provided as the parent component.
 *
 * ```js
 * component: 'anchor' | 'button' | 'div'
 *
...
export const NextButton = (props: NextButtonAllProps & arm_NextButtonAllProps) => {
  ...
  // Component type as root
  if (component === 'anchor') {
    const { onClick, href, target, as, ...anchorProps } = rest as hand_AnchorProps &
      NextButtonProps;
    return (
      <Link
        href={href}
  ...
  if (!component) {
    throw new Error(
      "Prop 'component' is required for NextButton component. You Must Define NextButton Component!"
    );
  }
